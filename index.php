    ...
    <div id="carouselExampleDark" class="carousel carousel-dark slide shadow-lg" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item" data-bs-interval="2000">
          <img src="Asset/siswa7.jpg" class="d-block w-100" height="750" alt="...">
          <div class="carousel-caption d-none d-md-block text-white">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-4 d-flex justify-content-center">
          <div>
            <img src="Asset/KEPSEK.png" height="300px" width="200px" class="bg-primary me-5 border-danger shadow-lg rounded" >
          </div>
        </div>
        <div class="col-8">
          <div class="fs-6">
            ...
            <p>
              Puji syukur kepada Allah SWT, Tuhan Yang Maha Esa yang telah memberikan rahmat dan anugerahNya sehingga website SMA Unggul 
              ini dapat dipublikasikan. Salah satu tujuan dari website ini adalah untuk menjawab akan setiap kebutuhan informasi dengan memanfaatkan sarana
                ...
                pendidikan, ilmu pengetahuan dan informasi seputar SMA Unggul.
            </p>
            <p>
              Besar harapan kami, sarana ini dapat memberi manfaat bagi semua pihak yang ada dilingkup pendidikan dan pemerhati pendidikan secara khusus bagi SMA Unggul.
            </p>
            <p>
              ...
              akan terus berkembang dan lebih baik nantinya. Terima kasih atas kerjasamanya, maju terus untuk mencapai SMA Unggul yang lebih baik lagi.
            </p>
            <p>Wassalamu'alaikum wr, wb.</p>
            <p>23 Desember 2021</p>
            <p>Kepala Sekolah SMA Unggul</p>
          </div>
        </div>
      </div>
    </div>
